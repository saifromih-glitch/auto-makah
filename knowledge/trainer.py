...
def seed_knowledge_base():
    ...
    # ─── Additional domains ───
    entries2 = [
        KnowledgeEntry("hr", "نطاقات والتوطين السعودي",
            "برنامج نطاقات: تصنيف المنشآت حسب نسبة التوطين. "
            "ممتاز — أخضر مرتفع — أخضر متوسط — أخضر منخفض — أصفر — أحمر. "
            "المزايا: نقل الكفالة — تجديد الإقامات — فتح فروع جديدة. "
            "نسبة التوطين المطلوبة تختلف حسب القطاع وحجم المنشأة.",
            ["نطاقات", "توطين", "سعودة"]),
        KnowledgeEntry("hr", "نظام العمل — التوظيف والتدريب",
            "فترة التجربة: ٩٠ يوم + ٩٠ تمديد. عقد العمل: محدد المدة أو غير محدد. "
            "الحد الأدنى للأجور للسعوديين: ٤٠٠٠ ريال. ساعات العمل: ٨/يوم — ٤٨/أسبوع. "
            "التدريب: إلزامي للمنشآت الكبيرة — برنامج هدف.",
            ["توظيف", "تدريب", "نظام عمل"]),
        KnowledgeEntry("finance", "السوق المالية السعودية — تداول",
            "TASI — المؤشر العام. القطاعات: بنوك — بتروكيماويات — اتصالات — تأمين. "
            "DCF = Σ (التدفقات النقدية / (1+WACC)^t). مضاعف الربحية P/E. "
            "التحليل الفني: متوسطات — MACD — RSI — Bollinger Bands.",
            ["تداول", "TASI", "أسهم", "DCF"]),
        KnowledgeEntry("strategy", "رؤية 2030 — الفرص الاستثمارية",
            "مشاريع كبرى: نيوم — القدية — روشن — البحر الأحمر — بوابة الدرعية. "
            "برامج: صندوق الاستثمارات العامة PIF — منشآت — هيئة المحتوى المحلي. "
            "حوافز: إعفاءات ضريبية — تمويل — أراضي — تراخيص. "
            "القطاعات المستهدفة: سياحة — تقنية — صناعة — تعدين — لوجستيات.",
            ["رؤية 2030", "PIF", "نيوم"]),
    ]
